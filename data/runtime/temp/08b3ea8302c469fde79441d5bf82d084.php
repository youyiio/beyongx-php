<?php /*a:2:{s:74:"D:\server\wnmp\wwwroot\Cms\application\admin\view\article\articleStat.html";i:1556273981;s:66:"D:\server\wnmp\wwwroot\Cms\application\admin\view\public\base.html";i:1556273981;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
  <meta charset="utf-8">
            ...
            <div class="ibox-content" style="padding:10px">
                <div class="col-lg-4 col-md-4 m-b-xs ">
                    <div class="form-group">
                        ...
                        <?php else: ?>
                        <button class="btn btn-default btn-sm">文章查看量<span class="badge badge-info"><?php echo htmlentities($count); ?></span>
                        </button>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="row col-lg-12">
                    <div class="pull-right">
                        <div class="btn-group">
                            <button type="button" class="btn btn-xs btn-success btn-tab" data-action="<?php echo url('article/echartShow',['id'=>$id,'start'=>$startTimestamp,'end'=>$endTimestamp]); ?>">
                                报表
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-border">
                                ...
                                <tr>
                                    <td><?php echo htmlentities($vo['last_update_time']); ?></td>
                                    <td><span title="<?php echo htmlentities($vo['meta_value']); ?>"><?php echo htmlentities(ip_to_address($vo['meta_value'], 'province,city')); ?>(<?php echo htmlentities($vo['meta_value']); ?>)</span>
                                    </td>
                                </tr>
